...
class MVTecDRAEMTrainDataset(Dataset):
    ...
    def __init__(self, root_dir, anomaly_source_path, resize_shape=None):
        ...
        self.anomaly_source_paths = sorted(glob.glob(anomaly_source_path+"/*/*.tif"))

        print('image_paths : ', self.image_paths[:20])
        print('anomaly_source_paths : ', self.anomaly_source_paths[:20])
