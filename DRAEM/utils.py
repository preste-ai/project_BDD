...
def adapt_and_test(model, batch, ways, shot, query_num, metric=None, device=None, nb_adapt_steps=20):
    adapted_model = copy.deepcopy(model)
    for name, param in adapted_model.encoder.named_parameters():
        param.requires_grad = False
    optimizer = torch.optim.Adam(adapted_model.parameters(), lr=0.00005)
